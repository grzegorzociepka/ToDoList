    ...
    <div class="wrapper">
      <div class="wrapper first">
        ...
        <div class="rightSide">
          ...
          <div class="dataBox">
            <div class="firstName dataLabel" @click="$modal.show('userModal')">Imię: {{userData[1]}}</div>
            <div
              class="secondName dataLabel" @click="$modal.show('userModal')">Nazwisko: {{userData[2]}}</div>
            <div class="city dataLabel" @click="$modal.show('userModal')">Miasto: {{userData[0]}}</div>
            <div class="street dataLabel" @click="$modal.show('userModal')">Ulica: {{userData[3]}}</div>
          </div>
